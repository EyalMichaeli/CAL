...
nohup python train.py \
    ...
    --seed 2 \
    --train_sample_ratio 1.0 \
    --logdir logs/compcars-parts/aug-controlNet-edges-120-200-txt2sentance-clip_filtering \
    --dataset compcars-parts \
    --aug_json /mnt/raid/home/eyal_michaeli/datasets/aug_json_files/compcars-parts/canny/canny_txt2sentence_v1_random_prompt_prompt_with_sub_class_num_per_image_2_gs_7.5_num_inf_steps_30_controlnet_scale_1.0_low_120_high_200_seed_0_images_lpips_filter_None_None_clip_filtering_per_class_discount_1.json \
    --aug_sample_ratio 0.5 \
    --stop_aug_after_epoch 160 \
    --use_target_soft_cross_entropy \
    > nohup_outputs/compcars-parts/aug.log 2>&1 &
